...
public class OverlayView extends View implements SensorEventListener, LocationListener {
	...
	public OverlayView(Context context) {
		...
		//Code ajoute 1Ligne
		contentPaint.setShadowLayer(25, 0, 0, Color.BLACK);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (lastLocation != null) {
			text.append(String.format("GPS = (%.3f, %.3f) @ (%.2f meters up)", lastLocation.getLatitude(), lastLocation.getLongitude(), lastLocation.getAltitude())).append("\n");

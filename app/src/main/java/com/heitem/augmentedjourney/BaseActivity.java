...
import com.heitem.others.NavDrawerItem;
import com.heitem.adapters.NavDrawerListAdapter;
...
public class BaseActivity extends Activity {
	...
	private void displayView(int position) {
		switch (position) {
		case 0:
			/*if(!MainActivity.isAppSentToBackground(getApplicationContext())) {
			...
			try {
				startActivityForResult(builder.build(BaseActivity.this), REQUEST_PLACE_PICKER);
